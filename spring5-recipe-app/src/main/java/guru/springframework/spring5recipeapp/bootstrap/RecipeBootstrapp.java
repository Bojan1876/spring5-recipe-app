...
@Component
@Profile("default")
public class RecipeBootstrapp implements ApplicationListener<ContextRefreshedEvent> {

	private final CategoryRepository categoryRepository;
	private final RecipeRepository recipeRepository;
	private final UnitOfMeasureRepository unitOfMeasureRepository;

	public RecipeBootstrapp(CategoryRepository categoryRepository, RecipeRepository recipeRepository,
	...
	private List<Recipe> getRecipe() {
		...
		if (!eachUomOptional.isPresent()) {
			throw new RuntimeException("Ecpected UOM not found!!!");
		}
		...
		guacRecipe.addIngredient(new Ingredient("serrano chiles, stems and seeds removed, mineced", new BigDecimal(2), tableSpoonUom));
